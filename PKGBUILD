...
arch=('x86_64')
url="https://github.com/hmadzfx/cursor-free-vip"
...
source=("cursor-free-vip::git+https://github.com/hmadzfx/cursor-free-vip.git" "https://raw.githubusercontent.com/canmi21/openjlc/refs/heads/main/LICENSE")
