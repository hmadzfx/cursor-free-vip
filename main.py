    ...
    try:
        ...
        if is_newer_version_available:
            ...
            try:
                ...
                if platform.system() == 'Windows':
                    update_command = 'irm https://raw.githubusercontent.com/hmadzfx/cursor-free-vip/main/scripts/install.ps1 | iex'
                    ...
                    install_script_url = 'https://raw.githubusercontent.com/hmadzfx/cursor-free-vip/main/scripts/install.sh'
